...
var open_animation = "zoom_flip"
var close_animation = "minimize_to_left"
...
var kwinDevEffect = {
    ...
    windowClosed: function (window) {
        ...
        close_params.forEach(function (sub_effect) {
            effect.animate(window, Effect[sub_effect.effect], kwinDevEffect.duration, sub_effect.to, sub_effect.from)
        })
